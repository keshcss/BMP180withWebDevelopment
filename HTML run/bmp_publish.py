...
while True:
    ...
    client.publish("Reading",device)
    print("\nReading: " + str(count))
    client.publish("Temperature", str(bmp085.read_temperature()) + dc)
    print("Published Temperature: " + str(bmp085.read_temperature()) + " to Temperature")
    client.publish("Pressure", str(bmp085.read_pressure()) + kp)
    print("Published Pressure: " + str(bmp085.read_pressure()) + " to Pressure\n") 
    client.publish("newl", nl)
    #client.publish("Altitude", str(bmp085.read_altitude()) + m )
    #print("Published Altitude: " + str(bmp085.read_altitude()) + " to Altitude\n")
    client.publish("TemperatureINT", str(bmp085.read_temperature()))
    client.publish("PressureINT", str(bmp085.read_pressure()))
    count = count + 1
    time.sleep(2.5)
